...
export const Route = createFileRoute("/contact")({
    head: () => ({
        meta: [
            ...
            {
                name: "description",
                content: "Tell us about your project. We respond within one business day. Email trionyxxsolutions@gmail.com",
            },
